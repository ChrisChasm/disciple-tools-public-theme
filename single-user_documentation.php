    ...
    <div class="page-inner-wrapper">
        ...
        <nav id="post-nav">
            <div class="breadcrumb hide-for-small-only">
                ...
                <a href="<?php echo esc_url( home_url() ); ?>/user-docs">User Documentation</a>&nbsp;&nbsp;&#187;&nbsp;&nbsp;
                <?php echo esc_html( the_title() ) ?>
            </div>
            <div class="breadcrumb-mobile show-for-small-only"><a href="<?php echo esc_url( home_url() ); ?>/user-docs">User Documentation</a></div>
        </nav>
