            ...
            <div class="grid-x grid-margin-x grid-margin-y white-section">
                ...
                <div class="medium-10 cell center">
                    <div class="grid-x grid-padding-x center">
                        <div class="cell"><img src="<?php echo esc_url( dtps_images_uri() )?>dtps-logo.svg" style="max-height:100px" id="home-logo" alt="welcome-graphic" /></div>
                        <div class="cell"><p class="large-text">to saturate the world with multiplying disciples<br>in our generation.</p></div>
                        <div class="cell"><img src="<?php echo esc_url( dtps_images_uri() )?>vision/jesus-globe.png" alt="disciple making movements" style="max-height:250px"  /></div>
                        <div class="cell"><h1 id="dtps-vision" class="large-text">Zúme is a community of practice <br>for those who want to see disciple making movements.</h1></div>
