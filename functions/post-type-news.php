...
/**
 * DTPS_News_Post_Type Post Type Class
 * All functionality pertaining to project update post types in DTPS_News_Post_Type.
 *
 * @package  Disciple_Tools
 * @since    0.1.0
 */
class DTPS_News_Post_Type
{
    /**
     * The post type token.
     *
    ...
    /**
     * DTPS_News_Post_Type The single instance of DTPS_News_Post_Type.
     * @var     object
     * @access  private
     * @since   0.1
     */
    ...
    /**
     * Main DTPS_News_Post_Type Instance
     *
     * Ensures only one instance of DTPS_News_Post_Type is loaded or can be loaded.
     *
     * @return DTPS_News_Post_Type instance
     * @since 0.1
     * @static
     */
     ...
     */
    public function __construct( $post_type = 'news', $singular = 'News', $plural = 'News', $args = array(), $taxonomies = array()) {
        ...
        register_post_type($this->post_type, /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
            ...
            array(
                'labels' => array(
                    ...
                    'all_items' => 'All News', /* the all items menu item */
                    'add_new' => 'Add New', /* The add new menu item */
                    'add_new_item' => 'Add New News', /* Add New Display Title */
                    'edit' => 'Edit', /* Edit Dialog */
                    'edit_item' => 'Edit News', /* Edit Display Title */
                    'new_item' => 'New News', /* New Display Title */
                    'view_item' => 'View News', /* View Display Title */
...
//        add_meta_box($this->post_type . '_scribes', 'News', array($this, 'load_report_meta_box'), $this->post_type, 'normal', 'high');
    } // End meta_box_setup()
