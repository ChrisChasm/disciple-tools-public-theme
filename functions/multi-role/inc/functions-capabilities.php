...
add_filter( 'dtps_multi_role_get_capabilities', 'dtps_multi_role_remove_old_levels' );
add_filter( 'dtps_multi_role_get_capabilities', 'dtps_multi_role_remove_hidden_caps' );
 ...
 * @return string
 */
function dtps_multi_role_sanitize_cap( $cap ) {
    return apply_filters( 'dtps_multi_role_sanitize_cap', sanitize_key( $cap ) );
}
 ...
 * @return bool
 */
function dtps_multi_role_cap_exists( $cap ) {
    return in_array( $cap, dtps_multi_role_get_capabilities() );
}
 ...
 * @return bool
 */
function dtps_multi_role_is_cap_editable( $cap ) {

    $uneditable = array_keys( dtps_multi_role_get_uneditable_role_names() );

    return ! in_array( $cap, dtps_multi_role_get_wp_capabilities() ) && ! array_intersect( $uneditable, dtps_multi_role_get_cap_roles( $cap ) );
}
 ...
 * @return array
 */
function dtps_multi_role_get_cap_roles( $cap ) {
    global $wp_roles;
 ...
 * @return array
 */
function dtps_multi_role_get_capabilities() {

    // Merge the default WP, role, and plugin caps together.
    $capabilities = array_merge(
        dtps_multi_role_get_wp_capabilities(),
        dtps_multi_role_get_role_capabilities(),
        dtps_multi_role_get_plugin_capabilities()
    );

    // Apply filters to the array of capabilities.
    $capabilities = apply_filters( 'dtps_multi_role_get_capabilities', $capabilities );
 ...
 * `dtps_multi_role_get_plugin_capabilities()` will return all the defaults.
 *
 * @since  0.1.0.0
 * @global object  $wp_roles
 * @return array
 */
function dtps_multi_role_get_role_capabilities() {
    global $wp_roles;
 ...
 * @return array
 */
function dtps_multi_role_get_plugin_capabilities() {
 ...
 * @return array
 */
function dtps_multi_role_get_wp_capabilities() {
 ...
 * @return bool
 */
function dtps_multi_role_check_for_cap( $cap = '' ) {
    ...
    return in_array( $cap, dtps_multi_role_get_role_capabilities() );
}
 ...
 * @return array
 */
function dtps_multi_role_get_hidden_caps() {
 ...
 * @return array
 */
function dtps_multi_role_remove_hidden_caps( $caps ) {
    return apply_filters( 'dtps_multi_role_remove_hidden_caps', true ) ? array_diff( $caps, dtps_multi_role_get_hidden_caps() ) : $caps;
}
 ...
 * @return array
 */
function dtps_multi_role_get_old_levels() {
 ...
 * add the `__return_false` filter to the `dtps_multi_role_remove_old_levels` hook to utilize user levels.
 *
 * @since  0.1.0.0
 * @access public
 * @param  array  $caps
 * @return array
 */
function dtps_multi_role_remove_old_levels( $caps ) {
    return apply_filters( 'dtps_multi_role_remove_old_levels', true ) ? array_diff( $caps, dtps_multi_role_get_old_levels() ) : $caps;
}
 ...
 * @return array
 */
function dtps_multi_role_new_role_default_capabilities() {

    return apply_filters( 'dtps_multi_role_new_role_default_capabilities', [ 'read' ] );
}
 ...
 * @return array
 */
function dtps_multi_role_new_role_default_caps() {

    return apply_filters( 'dtps_multi_role_new_role_default_caps', [ 'read' => true ] );
}
